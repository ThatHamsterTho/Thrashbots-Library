...
#define GLCD_CHAR_COLS 	  18 /* << Max characters over a row */
#define GLCD_CHAR_ROWS     4 /* << Amount of rows on the LCD */

#define GLCD_COLS		 128 /* << Width of the LCD in pixels */
#define GLCD_ROWS		   4 /* << Height of the LCD in rows */

#define PIXEL_COL		   0 /* << Designates if the Column value is in pixels */
#define CHAR_COL		   1 /* << Designates if the Column value is in characters */
